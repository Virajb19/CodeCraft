...
export default function DeleteButton({commentId, snippetId}: {commentId: string, snippetId: string}) {
  ...
  return  <button onClick={() => {  
            ...
            }} disabled={isPending} className="absolute opacity-40 group-hover:opacity-100 transition-all top-3 right-5 p-2 rounded-lg hover:bg-red-500/20 hover:text-red-500 disabled:cursor-not-allowed disabled:opacity-100 disabled:hover:bg-transparent">  
            {isPending ? (
